...
var ThumbnailList = function (_a) {
    ...
    return (React__namespace.createElement("div", { ref: containerRef, "data-testid": "thumbnail__list", className: core.classNames({
        ...
        .fill(0)
        .map(function (_, index) { return (React__namespace.createElement("div", { key: "thumbnail-" + index },
        React__namespace.createElement("div", { className: core.classNames({
            ...
            }), role: "button", tabIndex: currentPage === index ? 0 : -1, onClick: function () { return onJumpToPage(index); } },
        ...
        React__namespace.createElement("div", { className: "rpv-thumbnail__index" }, index + 1))); })));
};
